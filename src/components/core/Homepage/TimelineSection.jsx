...
const TimelineSection = () => {
  return (
    <div>
        <div className='flex flex-row gap-15 items-center mb-10 lg:flex md:flex-wrap sm:flex-wrap md:justify-center sm:justify-center sm:gap-10 md:gap-10'>
            <div className='lg:w-[45%] flex flex-col gap-5 md:w-[80%] sm:w-[80%]'>
                {
